...
public class MailConfiguration {
    ...
    private static final String APPLICATION_NAME="TwitterClone";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)throws IOException{
        ...
        if(in==null){
            throw new FileNotFoundException("No such directories");
        }
    ...
    public  Gmail getService() throws GeneralSecurityException, IOException {
        NetHttpTransport HTTP_TRANSPORT;
            ...
            return new Gmail.Builder(new NetHttpTransport(),GsonFactory.getDefaultInstance(), getCredentials(HTTP_TRANSPORT))
